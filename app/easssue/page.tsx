    ...
    <div className="w-full bg-gradient-to-t from-[#E7CEA6] to-[#EDFAFD] min-h-screen">
      <div className="w-full h-[50vh] relative">
        ...
        <div className="absolute top-[60%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
          ...
          TypeScript를 이용하여 개발을 진행하였으며, 웹 페이지가 아닌 확장 프로그램을 만들면서 DOM 조작, 크롬 api가 제공하는 기능을 활용한 다양한 기능들을 개발 하는 경험을 할 수 있어서 재미 있고 의미 있는 프로젝트 였습니다. 또한 개발 완료한 확장 프로그램을 배포하는 과정에서 구글 측의 까다로운 기준을 맞추느라 힘들었지만 성공적으로 배포를 완료하며 단순히 기능을 구현하는 것 이외에 보안, 사용자 권한 이용 등의 사항도 중요하다는 것을 알게 되었습니다.<br/>
          </p>
        </div>
      </div>
